...
const NewsletterWelcomeEmail: FC = () => {
  return (
    ...
    >
      ...
      <Text style={{ fontSize: '14px', color: '#333233', lineHeight: '1.7', fontFamily: 'sans-serif' }}>
        You&apos;ll receive reflections on cellular health, chrononutrition, stress, habits, and the small changes that
        lead to lasting transformation.
      </Text>
      <Text style={{ fontSize: '14px', color: '#333233', lineHeight: '1.7', fontFamily: 'sans-serif' }}>
        To make sure you receive every edition, reply to this email with &ldquo;Hello&rdquo; or add this address as a
        contact.
      </Text>
      <Text style={{ fontSize: '14px', color: '#333233', lineHeight: '1.7', fontFamily: 'sans-serif' }}>
